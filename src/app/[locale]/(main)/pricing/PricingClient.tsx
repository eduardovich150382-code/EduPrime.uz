...
export default function PricingClient() {
  ...
  // /build (kvota taklif oynasi) shu yerga joriy filtrlarni returnUrl
  // sifatida qo'shib yuboradi — sotib olgandan keyin foydalanuvchi aynan
  // shu konfiguratsiyaga qaytsin. Faqat saytning o'z (nisbiy) manzili
  // qabul qilinadi — tashqi domenga ochiq yo'naltirish bo'lmasligi uchun.
  const returnUrlParam = searchParams.get('returnUrl');
  const returnUrl = returnUrlParam?.startsWith('/') ? returnUrlParam : undefined;
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <BackButton className="mb-2" href={returnUrl} />
      {/* Header */}
      <motion.div
