...
export default function PricingPage() {
  ...
  const handleBuy = (plan: string, duration: string) => {
    // Redirect to Telegram bot
    window.open('https://t.me/EduPrimeuzbot?start=buy', '_blank');
  };
        ...
        {plans.map((plan, index) => (
          ...
          >
            ...
            <div className="text-center">
              ...
              <button
                onClick={() => handleBuy(plan.key, '1_month')}
                className={`w-full py-3 rounded-xl font-semibold text-center transition-all duration-300 flex items-center justify-center gap-2 ${
                  plan.popular
                    ...
                    : plan.key === 'free' ? 'bg-gray-100 text-text-secondary' : 'btn-primary'
                }`}
              >
