...
import { Send, Chrome, ArrowLeft, Sparkles } from 'lucide-react';
          ...
          <div className="mt-6 p-4 rounded-xl bg-primary-50 border border-primary-100">
            <div className="flex items-start gap-3">
              ...
              <p className="text-xs text-text-secondary leading-relaxed">
                Telegram orqali kirish uchun @EduPrimeuzbot ga /start buyrug&apos;ini yuboring. 
                Bot sizga avtomatik kirish havolasini beradi.
              </p>
            </div>
          </div>
        </div>
